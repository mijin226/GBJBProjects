...
public class HandlerMapper {
	...
	public HandlerMapper() {
		...
		// 해당 코드는 View에 맞춰서 변경
		// page.do
		this.mapper.put("/", new CheckBoardPageAction());								// 게시글 수정 페이지 이동
		...
		this.mapper.put("/", new NewBoardPageAction());									// 신규게시글 페이지 이동
		...
		this.mapper.put("/update_phone.do", new UpdatePhoneNumAction());			// 전화번호 변경 Action
		this.mapper.put("/update_profilePic.do", new UpdateProfilePicAction());			// 프로필 사진 변경 Action
		
		// board.do
		this.mapper.put("/", new DeleteBoardAction());				// 게시글 삭제 Action
		//this.mapper.put("/", new InsertBoardAction());			// 게시글 작성 Action
		this.mapper.put("/", new SearchBoardsAction());				// 게시글 검색 Action
		this.mapper.put("/", new UpdateBoardAction());				// 게시글 수정 Action
		this.mapper.put("/", new ViewBoardAction());				// 게시글 보기 Action
	}
