...
public class LikeDAO {
	...
	private final String SELECTONE = "SELECT LIKE_NUM FROM BD_LIKE L JOIN BD_MEMBER M ON M.MEMBER_NUM = L.MEMBER_NUM"
			+ "JOIN BD_BOARD B ON B.BOARD_NUM =L.BOARD_NUM WHERE M.MEMBER_NUM = ? AND B.BOARD_NUM = ?";
	//좋아요 삭제
