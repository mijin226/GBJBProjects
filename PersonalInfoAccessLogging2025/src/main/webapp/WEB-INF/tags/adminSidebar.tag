	...
	<div class="sidebar-wrapper scrollbar scrollbar-inner">
		...
		<div class="sidebar-content">
			<ul class="nav nav-secondary">
				...
				<li class="nav-item">
					<!-- 네비게이션 항목 --> 
					<a data-bs-toggle="collapse" href="#declare" class="collapsed" aria-expanded="false"> <!-- 대시보드 토글 --> <i
				...
				<!-- 가입 회원 정보 목록 -->
				<li class="nav-item"><a href="allMemberList.do"> <!-- 커뮤니티 사이트 이동 -->
						<i class="fas fa-store"></i> <!--집모양 아이콘-->
						<p>가입 회원 정보</p>
				</a></li>
				<!-- 개인정보 접속 탐지 로그 목록 -->
				<li class="nav-item">
					<!-- 네비게이션 항목 --> <a data-bs-toggle="collapse" href="#privateInfo"
					class="collapsed" aria-expanded="false"> <!-- 대시보드 토글 --> <i
						class="fas fa-store"></i> <!-- 집모양 아이콘 -->
						<p>개인정보 탐지</p> <span class="caret"></span> <!-- ▼ 아이콘 -->
				</a>
					<div class="collapse" id="privateInfo">
						<!-- 가게 제보 하위 목록 -->
						<ul class="nav nav-collapse">
							<li><a href="selectMemberInfoAdmin.do"> <span
									class="sub-item">특정 관리자 접속기록</span>
							</a></li>
							<li><a href="selectMemberInfoAdminStatistics.do"> <span
									class="sub-item">접속기록 통계</span>
							</a></li>
						</ul>
					</div>
				</li>
